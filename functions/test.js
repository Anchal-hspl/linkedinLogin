...
exports.handler = async function(event, context, callback){
    ...
    var config = {
        method: 'post',
        url: 'https://www.linkedin.com/oauth/v2/accessToken?client_id=86ftg6210chpct&client_secret=TyKsNyHF4fvNXvrp&redirect_uri=http%3A%2F%2F127.0.0.1%3A9000%2Ftest&code='+code+'&grant_type=authorization_code',
        headers: { 
